    ...
    <body>
        ...
        <div id="home" class="section intro-page">
            <div class="block content-1170 center-relative center-text">
                <img class="top-logo" src="demo-images/logo.png" alt="Pioneer" />
                <br>
        ...
        <!-- News -->
        <div id="news" class="section" style="background-image:url(mockup-images/background_img_04.jpg);"">
                    ...
                    <div class="content-wrapper">
                        <div class="blog-holder block center-relative">
                            ...
                            <article class="relative blog-item-holder center-relative">
                                ...
                                <div class="info">
                                    <div class="author vcard ">Pioner Connect</div>
                                    <div class="cat-links">
                                        <ul>
                                ...
                                <h3 class="entry-title">
                                    <a href="#">Pioneer Connect (Pty) is an Information and Communication Technology (ICT) </a>
                                </h3>
                                <div class="clear"></div>
                            </article>
                            ...
                            <article class="relative blog-item-holder center-relative">
                                ...
                                <div class="info">
                                    <div class="author vcard ">Office</div>
                                    <div class="cat-links">
                                        <ul>
                                ...
                                <h3 class="entry-title">
                                    <a href="#">24 Evatt Street, Central, Port Elizabeth, 6001</a>
                                </h3>
                                <div class="clear"></div>
                            </article>
                            ...
                            <article class="relative blog-item-holder center-relative">
                                ...
                                <div class="info">
                                    <div class="author vcard ">Trading Hours</div>
                                    <div class="cat-links">
                                        <ul>
                                            <li><a href="#">9 am - 5 pm</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <h3 class="entry-title">
                            ...
                            <article class="relative blog-item-holder center-relative">
                                ...
                                <div class="info">
                                    <div class="author vcard ">Email</div>
                                    <div class="cat-links">
                                        <ul>
                                            <li><a href="#">info@pionerconnect.co.za </a></li>
                                        </ul>
                                    </div>
                                </div>
                                <h3 class="entry-title">
                                    <a href="#">You can use the contact box below to drop us a message and an agent will get back to you</a>
                                </h3>
                                <div class="clear"></div>
                            </article>
                ...
                <div class="section-content-holder right">
                    <div class="content-wrapper">
                        <div class="one_half ">
                            ...
                            <br>
                            <p><strong><span style="color: #e64b77;">Don't be shy </span></strong> send us a message and the nearest agent will get back to you.</p>
                        </div>
                    ...
                    <div class="full-width">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3309.3435207683106!2d25.61577611559885!3d-33.95800903112651!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1e7ad2f67bdd3f65%3A0x5572a6bbf5ccf071!2s24+Evatt+St%2C+Port+Elizabeth+Central%2C+Port+Elizabeth%2C+6001!5e0!3m2!1sen!2sza!4v1540498995641" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
